...
//    },
	...
	entry: {
		...
		'app-rtl': './'+globs.build+'/index-rtl.js',
		'app-rtl.min': './'+globs.build+'/index-rtl.js',
	},
    output: {
...
// 				src: [
// 					'./vendor/files/one-page-nav-min.js',
// 					'./vendor/files/imagesloaded.pkgd.min.js',
// 					'./vendor/files/isotope.pkgd.min.js',
// 					'./vendor/files/wow.min.js',
// 					'./vendor/files/popper.min.js',
// 					'./vendor/files/bootstrap.min.js',
// 					'./vendor/files/slick.min.js',
// 					'./vendor/files/jquery.magnific-popup.min.js',
// 					'./vendor/files/ajax-form.js',
// 					'./vendor/files/owl.carousel.min.js',
// 					'./vendor/files/jquery.scrollUp.min.js',
// 					'./vendor/files/jquery.meanmenu.min.js',
//                     './vendor/files/plugins.js'
// 				],
// 			},
// 		],
// 	})
...
if ( fs.existsSync( compilerCoreJSsFile ) ) {
    fs.readFile( compilerCoreJSsFile, 'utf8', function( err, content ) {
        ...
        compiler.hooks.done.tap( 'MyPlugin', ( compilation ) => {
            ...
            const targetJSFile = './'+globs.dist+'/js/app.js';

            //
            const tocBuildedFiles = ['./'+globs.dist+'/css/app.css', './'+globs.dist+'/css/app-rtl.css', targetJSFile ];
